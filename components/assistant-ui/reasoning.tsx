...
function ReasoningText({
  ...
  return (
    <div
      ...
      className={cn(
        "aui-reasoning-text relative z-0 ml-4 max-h-64 overflow-y-auto pt-2 pb-2 leading-relaxed text-pretty scrollbar-none [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden",
